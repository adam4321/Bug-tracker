/******************************************************************************
**  Description: ADD_PROJECT PAGE - server side node.js routes
**
**  Root path:   localhost:5000/bug_tracker/add_project
**
**  Contains:    /
**               /insertProject
**
...
/* ADD_PROJECT PAGE ROUTES ------------------------------------------------- */

router.get('/', checkUserLoggedIn, renderAddProjects);
